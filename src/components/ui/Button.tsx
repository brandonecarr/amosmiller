...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      primary:
        "bg-[var(--color-primary-500)] text-white hover:bg-[var(--color-primary-600)] focus:ring-[var(--color-primary-500)]",
      secondary:
        "bg-[var(--color-cream-200)] text-[var(--color-charcoal)] hover:bg-[var(--color-cream-300)] focus:ring-[var(--color-cream-400)]",
      outline:
      ...
      ghost:
        "text-[var(--color-charcoal)] hover:bg-[var(--color-slate-100)] focus:ring-[var(--color-slate-300)]",
      danger:
