    ...
    <div className="min-h-screen bg-[var(--color-slate-100)]">
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-[var(--color-slate-700)]">
          <Link
            href="/"
            className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-[var(--color-slate-300)] hover:bg-[var(--color-slate-800)] hover:text-white transition-colors"
          >
